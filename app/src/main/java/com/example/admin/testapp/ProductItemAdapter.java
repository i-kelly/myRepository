...
import widget.ProperRatingBar;
import widget.ShoppingCountView;
...
//        holder.photoImg.loadProductPhoto(product);
        ...
        holder.priceTxt.setText("价格");
        holder.monthSalesTxt.setText("月售");
...
//            int quantity = ShoppingCart.getInstance().getQuantityForProduct(finalProduct);
            holder.shoppingCountView.setShoppingCount(100);
...
//                    }
            ...
            holder.leftNumTxt.setText("月售1000");
