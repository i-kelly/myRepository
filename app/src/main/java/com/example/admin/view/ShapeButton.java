...
/*
 *  @项目名：  myRepository
 *  @包名：    com.example.admin.view
 *  @文件名:   ShapeButton
 *  @创建者:   Admin
 *  @创建时间:  2017/5/23 23:21
 *  @描述：    带背景button
 */
...

{
    ...
    public GradientDrawable getDrawable(int state) {
        ...
        switch (state) {
            case android.R.attr.state_pressed: gradientDrawable.setColor(stroke == 0
                                                                         ? color_pressed
                                                                         : Color.parseColor(
                                                                                 "#0C000000"));//设置颜色
            ...
            case -android.R.attr.state_enabled: gradientDrawable.setColor(stroke == 0
                                                                          ? color_disable
                                                                          : Color.parseColor(
                                                                                  "#06000000"));//设置颜色
